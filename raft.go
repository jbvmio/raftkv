...
func NewRaftStore(inmem bool) *RaftStore {
	return &RaftStore{
...
// MatchRegex uses a regex that returns all values that match the given key.
func (s *RaftStore) MatchRegex(key string) []string {
	var matches []string
